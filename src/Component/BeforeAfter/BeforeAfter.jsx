  ...
  return (
    <>
      ...
      <div className="text-white montserrat mb-5" lang={language}>
        ...
        {/* Body of cards */}
        <div className="row gx-0 mb-5 flexA">
          <div className="offset-1 col-10 px-4">
            ...
            <div className="row gy-2">
              {data.filter((item) => activeLink === 'all' || item.procedure.id == activeLink)
                .map((item, index) => (
                  <div id={item.procedureId} key={item.id} className="col-lg-3 col-md-5 col-sm-12" data-aos="fade-up" data-aos-duration={index * 500 + 1500}>
                    <div className="  me-xl-5 me-sm-4 card cursor-pointer border border-1 border-black rounded-1 overflow-hidden position-relative">
                      ...
                      <img src={item.imageUrl} className="w-100 ImGBOX h-100" alt="before&after" onClick={() => openCard(item.imageUrl)} />
                    </div>
                  </div>
                ))}
        ...
        <div className="row gx-0 bg-light py-5 pt-4 mb-5 flexA">
              ...
              <div className="col-lg-4 col-md-6">
                <div className="me-xl-5 me-sm-4 cursor-pointer overflow-hidden">
                  <div id="carouselExampleFade" className="carousel slide carousel-fade" data-bs-ride="carousel">
                    <div className="carousel-inner" style={{ height: "325px" }}>
                      <div className="carousel-item active" data-bs-interval="4000" onClick={() => openCarousel(after1)}>
                        <img style={{ height: "325px" }} src={after1} className="d-block  w-100" alt="First-Slide" />
                      </div>
                      <div style={{ height: "325px" }} className="carousel-item" data-bs-interval="4000">
                        <img style={{ height: "325px" }} src={after2} className="d-block w-100" alt="Second-Slide" onClick={() => openCarousel(after2)} />
                      </div>
                    </div>
        ...
        {/* Body of videos */}
        <div className="row gx-0 montserrat mb-5 flexA">
          <div className="offset-1 col-10 px-4">
            <div className="row gx-4 gy-5 col-12">
              {videos.map((video, index) => (
                <div key={video.id} className="col-sm-12 col-lg-3 col-md-6 position-relative" data-aos="fade-up" data-aos-duration={index * 500 + 1500}>
                  {token != null ? <div className="position-absolute top-0 end-0 z-2 mt-2 me-2">
                  ...
                  <div className="row g-1">
                    <div className="offset-3 col-12 pt-4 px-0">
                      <div>
