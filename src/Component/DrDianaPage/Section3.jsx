  ...
  return (
    <div className="section3">
      <div className="row">
        <div className="col half white-background">
          <div className="image-wrapper">
            <div className="image-hover">
              <img 
                src="https://www.drwilliammiami.com/wp-content/uploads/2020/05/EST-OGEE-LINE.jpg" 
                alt="OGEE Line"
              />
        ...
        <div className="col half blue-background">
          <div className="text-content">
            <h3>Ogee Lipo<sup>®</sup></h3>
            <p>
              Dr. William has a unique approach to liposuction and BBLs; 
